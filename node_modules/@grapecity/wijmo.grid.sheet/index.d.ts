...
import { Row, Column, CellRange, GridPanel, FlexGrid, DataMap, HitTestInfo, CellFactory, CellType, _SelectionHandler, SelMove, RowColCollection, RowCollection, ColumnCollection, SelectedState } from '@grapecity/wijmo.grid';
...
export declare class SheetCollection extends ObservableArray {
     ...
     */
    readonly sheetNameChanged: Event<SheetCollection, NotifyCollectionChangedEventArgs<any>>;
    /**
     ...
     */
    readonly sheetVisibleChanged: Event<SheetCollection, NotifyCollectionChangedEventArgs<any>>;
    /**
