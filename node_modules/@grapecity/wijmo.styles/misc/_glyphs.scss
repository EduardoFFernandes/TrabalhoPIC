...
.wj-glyph-calendar {
    ...
    top: .15em;
    //transform: translateY(.15em); // TFS 440092
    //overflow: hidden; // clip if needed (macOS: TFS 379685)
    //&:after {
    //    position: absolute;
    //    font-size: 50%;
    //    left: .5em;
...
.wj-glyph-circle {
    ...
    border-radius: 50%;
    top: -.1em;
    //transform: translateY(-.1em); // TFS 440092
}
...
.wj-glyph-step-backward {
    ...
    border-bottom: .4em solid transparent;
    top: .12em;
    //transform: translateX(.12em); // TFS 440092
    &:after {
        position: absolute;
