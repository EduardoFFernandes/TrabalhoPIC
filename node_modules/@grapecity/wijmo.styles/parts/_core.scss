...
.wj-control {
    ...
    *:focus,
    ...
    input {
        ...
        &::-ms-clear {
            // remove clear button in IE input elements
            display: none;
        }

        &[type=number] {

            // spinner buttons in Chrome
        ...
        &:invalid {
            // red outline validation in Firefox
            box-shadow: none;
