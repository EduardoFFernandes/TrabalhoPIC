...
declare module wijmo.olap {
    ...
    class PivotEngine {
         ...
         * </pre>
         *
         * The <b>catalog</b> property is optional, but <b>url</b> and <b>cube</b> are required.
         *
         ...
         * also include the appropriate <b>user</b> and <b>password</b> members
...
declare module wijmo.olap {
    ...
    class PivotGrid extends wijmo.grid.FlexGrid {
         ...
         *
         * ```typescript
         * let theEngine = new wijmo.olap.PivotEngine({
         *     showRowTotals: wijmo.olap.ShowTotals.Subtotals,
         *     totalsBeforeData: true,
         *     itemsSource: getData()
         * });
         * let theGrid = new wijmo.olap.PivotGrid('#theGrid', {
