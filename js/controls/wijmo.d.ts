...
declare module wijmo.collections {
    ...
    class ObservableArray<T = any> extends ArrayBase<T> implements INotifyCollectionChanged {
         ...
         * Occurs when the collection changes.
         */
        readonly collectionChanged: Event<ObservableArray<any>, NotifyCollectionChangedEventArgs<any>>;
        /**
...
declare module wijmo.collections {
    ...
    class CollectionView<T = any> implements IEditableCollectionView, IPagedCollectionView {
         ...
         *
         * This property is set to <b>false</b> by default, which causes the {@link CollectionView}
         ...
         * As of ES2019, sort is <b>required</b> to be stable. In ECMAScript 1st edition through
         ...
         *
         * This property is set to <b>true</b> by default, which ensures the
         * collection is always sorted, filtered, and grouped correctly after any
         * edit operations.
         *
         * Set it to <b>false</b> if you want updates to be deferred when items
         ...
         * Occurs when the collection changes.
         */
        readonly collectionChanged: Event<CollectionView<any>, NotifyCollectionChangedEventArgs<any>>;
        /**
         * Raises the {@link collectionChanged} event.
         *
         * @param e Contains a description of the change.
         ...
         */
        readonly sourceCollectionChanging: Event<CollectionView<any>, CancelEventArgs>;
        /**
         ...
         */
        readonly sourceCollectionChanged: Event<CollectionView<any>, EventArgs>;
        /**
         ...
         * Occurs after the current item changes.
         */
        readonly currentChanged: Event<CollectionView<any>, EventArgs>;
        /**
         ...
         * Occurs before the current item changes.
         */
        readonly currentChanging: Event<CollectionView<any>, CancelEventArgs>;
        /**
        ...
        * Occurs after the page index changes.
        */
        readonly pageChanged: Event<CollectionView<any>, EventArgs>;
        /**
         ...
         * Occurs before the page index changes.
         */
        readonly pageChanging: Event<CollectionView<any>, PageChangingEventArgs>;
        /**
...
declare module wijmo {
    ...
    class Tooltip {
         ...
         *
         * @param element Element, element CSS selector, or control that the tooltip explains.
