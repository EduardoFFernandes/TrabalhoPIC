...
declare module wijmo.grid.sheet {
    ...
    class Sheet {
        ...
        private _visible;
        _unboundSortDesc: collections.ObservableArray<any>;
    ...
    class SheetCollection extends wijmo.collections.ObservableArray {
         ...
         */
        readonly sheetCleared: Event<SheetCollection, EventArgs>;
        /**
         * Raises the sheetCleared event.
         */
        onSheetCleared(): void;
         ...
         */
        readonly selectedSheetChanged: Event<SheetCollection, EventArgs>;
        /**
         ...
         */
        readonly sheetNameChanged: Event<SheetCollection, collections.NotifyCollectionChangedEventArgs<any>>;
        /**
         ...
         */
        readonly sheetVisibleChanged: Event<SheetCollection, collections.NotifyCollectionChangedEventArgs<any>>;
        /**
